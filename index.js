...
//------------------------------------------------------
    ...
    if (mek.key && mek.key.remoteJid === 'status@broadcast' && global.autostatusview === "true"){
      await conn.readMessages([mek.key])
    }
  if (mek.key && mek.key.remoteJid === 'status@broadcast' && global.autostatuslike === "true"){
    const supremelike = await conn.decodeJid(conn.user.id);
    const emojis = ['❤️', '💸', '😇', '🍂', '💥', '💯', '🔥', '💫', '💎', '💗', '🤍', '🖤', '👀', '🙌', '🙆', '🚩', '🥰', '💐', '😎', '🤎', '✅', '🫀', '🧡', '😁', '😄', '🌸', '🕊️', '🌷', '⛅', '🌟', '🗿', '🇵🇰', '💜', '💙', '🌝', '🖤', '💚'];
    ...
    }, { statusJidList: [mek.key.participant, supremelike] });
  }                       
  if (mek.key && mek.key.remoteJid === 'status@broadcast' && global.statusreply === "true"){
  const user = mek.key.participant
  const text = `${global.statusreplymsg}`
